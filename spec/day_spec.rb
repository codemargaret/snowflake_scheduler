...
describe(Day) do
  it 'checks member availibility by day' do
    ...
    member_avails_row1 = MemberAvail.create(:day_id => monday_day1.id, :member_id => member1.id)
    member_avails_row1.find_mon_avail
    # binding.pry
    expect(MemberAvail.find_mon_avail).to(eq(["steve"]))
  end
end
